...
public class DataSource {
    ...
    public static void generateDummyAccounts() {

        addAccountToArrayList(mufc);
        addAccountToArrayList(acm);
        addAccountToArrayList(alnassr);
        addAccountToArrayList(madrid);
        addAccountToArrayList(arsenal);
        addAccountToArrayList(atm);
    ...
    public static void addAccountToArrayList(Account account) {
        account.setObjectId(accounts.size());
